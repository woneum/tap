...
package io.github.monun.tap.v1_21_10.protocol
...
class NMSPacketSupport : PacketSupport {
    companion object {
        private fun EquipmentSlot.toNMS(): NMSEquipmentSlot {
            return when (this) {
                ...
                EquipmentSlot.SADDLE -> NMSEquipmentSlot.SADDLE
            }
        }
    }
    ...
    override fun entityTeleport(
        ...
        val clazz = Class.forName("net.minecraft.network.protocol.game.ClientboundTeleportEntityPacket")
        val constructor = clazz.getDeclaredConstructor(FriendlyByteBuf::class.java)
        ...
        val packet = constructor.newInstance(byteBuf) as ClientboundTeleportEntityPacket
        return NMSPacketContainer(packet)
    }
    ...
    override fun entityHeadLook(entityId: Int, yaw: Float): NMSPacketContainer {
        val clazz = Class.forName("net.minecraft.network.protocol.game.ClientboundRotateHeadPacket")
        val constructor = clazz.getDeclaredConstructor(FriendlyByteBuf::class.java)
        constructor.isAccessible = true
        ...
        return NMSPacketContainer(constructor.newInstance(byteBuf) as ClientboundRotateHeadPacket)
    }
    ...
    override fun entityStatus(
        ...
        val clazz = Class.forName("net.minecraft.network.protocol.game.ClientboundEntityEventPacket")
        val constructor = clazz.getDeclaredConstructor(FriendlyByteBuf::class.java)
        constructor.isAccessible = true
        ...
        val packet = constructor.newInstance(byteBuf) as ClientboundEntityEventPacket
        return NMSPacketContainer(packet)
    }
    ...
    override fun entityAnimation(
        ...
        val clazz = Class.forName("net.minecraft.network.protocol.game.ClientboundAnimatePacket")
        val constructor = clazz.getDeclaredConstructor(FriendlyByteBuf::class.java)
        constructor.isAccessible = true
        ...
        return NMSPacketContainer(constructor.newInstance(byteBuf) as ClientboundAnimatePacket)
    }

    override fun hurtAnimation(entityId: Int, yaw: Float): PacketContainer {
        val clazz = Class.forName("net.minecraft.network.protocol.game.ClientboundHurtAnimationPacket")
        val constructor = clazz.getDeclaredConstructor(FriendlyByteBuf::class.java)
        constructor.isAccessible = true
        ...
        val packet = constructor.newInstance(byteBuf) as ClientboundHurtAnimationPacket
        return NMSPacketContainer(packet)
    }
    ...
    override fun mount(
        ...
        val clazz = Class.forName("net.minecraft.network.protocol.game.ClientboundSetPassengersPacket")
        val constructor = clazz.getDeclaredConstructor(FriendlyByteBuf::class.java)
        constructor.isAccessible = true
        ...
        val packet = constructor.newInstance(byteBuf) as ClientboundSetPassengersPacket
        return NMSPacketContainer(packet)
    }
